    ...
    public function blocks_for_region($region) {
        ...
        foreach ($blockcontents as $bc) {
            if ($bc instanceof block_contents) {
                ...
                $skipblock = $this->page->theme->settings->hidesettingsblock && substr($bc->attributes['class'], 0, 15) == 'block_settings ';
                $skipblock = $skipblock || ($this->page->theme->settings->hidenavigationblock && substr($bc->attributes['class'], 0, 17) == 'block_navigation ');
                if (!$skipblock) {
